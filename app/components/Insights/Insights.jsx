  ...
  return (
    ...
    >
      <InsightCard width={cardWith} variant="turquoise" icon="calendar-heart-outline">
        U heeft al <Paragraph isStrong>4 dagen</Paragraph> geen opname meer gehad.
      </InsightCard>
      <InsightCard width={cardWith} variant="ochre" icon="run">
        U maakte al <Paragraph isStrong>2 keer</Paragraph> een opname na het sporten.
      </InsightCard>
      <InsightCard isLast variant="success" width={cardWith} icon="trend-down">
        U had dit jaar <Paragraph isStrong>minder</Paragraph> opnames dan in 2022.
      </InsightCard>
    </ScrollView>
  );
};
