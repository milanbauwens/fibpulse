  ...
  const data = [
    {
      ...
      category: "Bewegen",
      content:
        "Dagelijks bewegen erg goed is voor de bloedsomloop en dus ook voor je hart.",
      imageURL:
    ...
    },
    {
      ...
      category: "Voeding",
      content:
        "Gevarieerde voeding even belangrijk is dan dagelijks dezelfde gezonde voeding?",
      imageURL:
    ...
    },
    {
      ...
      category: "Alcohol",
      content:
        "Je maximum 7 eenheden alcohol per week mag nuttigen om je hart niet te belasten?",
      imageURL:
